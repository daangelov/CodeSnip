...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['id'])) {
    ...
    $stmt = $db->prepare('SELECT is_public FROM snippet WHERE id = ? AND creator_id = ?');
        ...
        $response['content'] = '
            <div class="popover-snip-share">
                ...
                <div ' . $display . ' class="input-group copy-share">
                    <input type="text" class="form-control input-monospace input-sm input-cp-snip" value="' . BASE_URL . 'preview.php?id=' . $snippet_id . '" readonly="">
                    <span class="input-group-btn">
